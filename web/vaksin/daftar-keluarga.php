      ...
      <div class="card">
        ...
        <div class="card-body bd-0 pd-0">
          <div class="row row-xs pd-x-20 pd-y-5">
            ...
            <div class="col-12">
              <p class="tx-poppins tx-16 mg-b-5 crop-text-1 mg-b-40 mg-l-20">Untuk Anggota Keluarga/THL</p>
            </div>
            <form>
              <div class="modal-body">
                <p class="tx-poppins tx-medium tx-16 mg-b-0">Identitas Anggota Keluarga</p>
                <p class="tx-color-03 tx-13">Mohon diisi sesuai dengan identitas asli.</p>
                <div class="form-group form-floating">
                  <input type="text" class="form-control" id="nama" name="nama" placeholder="Nama" required>
                  <label for="nama-kegiatan">Nama</label>
                </div>
                <div class="form-group form-floating">
                ...
                <div class="form-group form-floating">
                  <select class="form-select" id="status-hubungan" name="status-hubungan" aria-label="Floating label select example" required>
                    <option value="" selected>Pilih</option>
                    <option value="1">Suami</option>
                    <option value="2">Istri</option>
                    <option value="3">Anak</option>
                  </select>
                  <label for="status-hubungan">Status Hubungan dalam Keluarga:</label>
                </div>
                <div class="form-group form-floating">
